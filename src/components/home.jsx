...
const Home = () => {
  ...
  useEffect(() => {
    init(textRef.current, {
      ...
      backDelay: 1500,
      backSpeed: 70,
      strings: [`Software Developer 💻 `, 'Frontend Engineer 🎨', 'Soccer Enthusiast ⚽', 'Outdoors Lover ⛰️', 'Foodie 🍕', 'Traveler 🌏'],
    });
  }, [])
  return (
    <div className='mainContainer'>
      ...
      <div className='avatar'>
        ...
        <div className='avatar-container'>
          <img src="/images/myAvatar.png" alt="avatar" className='avatarImg' />
        </div>
      </div>
    </div>
  )
